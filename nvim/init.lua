...
require('packer').startup(function(use)
  ...
  use 'mfussenegger/nvim-dap' -- Adaptive Debug Protocol
  -- use 'jose-elias-alvarez/null-ls.nvim' -- Linter and formatter
  use { "rcarriga/nvim-dap-ui", requires = {"mfussenegger/nvim-dap"} }

  -- virtual text support to find variable names in nvim-dap
  use { "theHamsta/nvim-dap-virtual-text" }
  -- telescope dap support
  ...
  -- use vim-flog for git log pretty graph
  use {
    "rbong/vim-flog",
...
-- nvim vscode-cpptools dap
local dap = require('dap')
dap.adapters.cppdbg = {
  id = 'cppdbg',
  type = 'executable',
  command = '/home/wassim/extension/debugAdapters/bin/OpenDebugAD7',
}
